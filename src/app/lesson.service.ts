...
export class LessonService {
  ...
  private writeNegativeSentencesExercises: WriteQuestionsExercise[] = [
    ...
    {
      id: 4,
      statement: 'I play tennis.',
      expectedResponse: "I don't play tennis.",
      userResponse: { text: '' },
      words: [],
    },
    {
      id: 5,
      statement: 'He has a beard.',
      expectedResponse: "He doesn't have a beard.",
      userResponse: { text: '' },
      words: [],
    },
    {
      ...
      expectedResponse: "They don't go to the gym.",
      userResponse: { text: '' },
      words: [],
    },
    {
      id: 7,
      statement: 'She writes a blog.',
      expectedResponse: "She doesn't write a blog.",
      userResponse: { text: '' },
      words: [],
    },
  ];
    ...
    },
    {
      ...
      sections: {
        ...
        activities: [
          ...
          {
            id: 'b',
            title: 'Complete the questions with do or does.',
            type: 'put-words',
            exercises: [
              {
                id: 1,
                statement: 'When do you meet your friends?',
                expectedResponse: 'do',
                userResponse: { text: 'When do you meet your friends?' },
                words: ['do', 'does'],
              },
              {
                id: 2,
                statement: 'Does your laptop have a webcam?',
                expectedResponse: 'Does',
                userResponse: { text: '' },
                words: ['do', 'does'],
              },
              {
                id: 3,
                statement: 'What time do we need to leave?',
                expectedResponse: 'do',
                userResponse: { text: '' },
                words: ['do', 'does'],
              },
              {
                id: 4,
                statement: 'Does your mother work from home?',
                expectedResponse: 'does',
                userResponse: { text: '' },
                words: ['do', 'does'],
              },
              {
                id: 5,
                statement: 'Which websites do you use most?',
                expectedResponse: 'do',
                userResponse: { text: '' },
                words: ['do', 'does'],
              },
              {
                id: 6,
                statement: 'Does your girlfriend like action films?',
                expectedResponse: 'does',
                userResponse: { text: '' },
                words: ['do', 'does'],
              },
              {
                id: 7,
                statement: 'Does your brother spend a long time on Facebook?',
                expectedResponse: 'does',
                userResponse: { text: '' },
                words: ['do', 'does'],
              },
